...
public class tienda1 extends javax.swing.JFrame {
    ...
    public tienda1() {
       ...
       String[] titulos = {"codigo","instrumento", "precio unitario","cantidad ingresada", "fecha"};
...
public void insertarDatos() {
      try{
            String SQL = "INSERT INTO producto (codigo_producto, nombre_productc , precio_unitario, cantidad_producto, fecha_ingreso) VALUES(?,?,?,?,?)";
            
            PreparedStatement pst = cn.prepareStatement(SQL);
            
            pst.setString(1, txtcodigo.getText());
            pst.setString(2, txtinstrumento.getText());
   ...
   public void eliminarDatos(){
       ...
       try{
           String SQL = "DELETE FROM producto WHERE codigo_producto="+tbproducto.getValueAt(filaSeleccionada, 0);
 ...
 public void actualizarDatos(){
       try{
           String SQL = "UPDATE producto SET nombre_productc=?,precio_unitario=?, cantidad_producto=?, fecha_ingreso=? WHERE codigo_producto=? ";
           ...
           pst.setString(1, txtinstrumento.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(192, 183, 251));

        jLabel1.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("CASA INSTRUMENTAL");
        ...
        jLabel7.setText("Cantidad ingresada");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Users\\samuel\\Downloads\\222.jpg")); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtinstrumento, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtinstrumento, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jButton5.setText("REPOTERIA PDF");
    ...
    private void tbproductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbproductoMouseClicked
        ...
        txtinstrumento.setText(tbproducto.getValueAt(filaSeleccionada, 1).toString());
    ...
    private void txtbusquedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtbusquedaActionPerformed
        // TODO add your handling code here:
        String nombre_producto_encontrado = "";
        int codigo_producto_encontrado = 0;
        ...
        if(txtbusqueda.getText().length() < 4){
            JOptionPane.showMessageDialog(null, "Ingrese un minimo de 4 caracteres");
            return;
        }
        
       
        try {
            String query = "SELECT * FROM producto WHERE nombre_productc like '%"+ txtbusqueda.getText() +"%'";
            Statement st = cn.createStatement();
            ...
            while(rs.next()){
                ...
                nombre_producto_encontrado = rs.getString(2);
                System.out.println(codigo_temp);
//                System.out.println(codigo_producto_encontrado);
            ...
            if(nombre_producto_encontrado.length() > 1){
                JOptionPane.showMessageDialog(null, """
                                                    Su busqueda es
                                                    Codigo""" + codigo_producto_encontrado + "\nNombre producto: " + nombre_producto_encontrado + "\nEl precio del producto: ");
            
            }else {
                JOptionPane.showMessageDialog(null, "Instrumento no encontrado, intente de nuevo");
            }
            
        } catch (Exception e) {
            System.out.println("Errror al buscar producto" + e );
        }
